...
public class DispatcherServlet extends FrameworkServlet {
	 ...
	 * will dictate(规定) which XML files will be loaded by the
	 * {@linkplain #DEFAULT_CONTEXT_CLASS default XmlWebApplicationContext}
	 * <p>Calling {@link #setContextClass} (init-param 'contextClass') overrides the
	 * default {@code XmlWebApplicationContext} and allows for specifying an alternative(备选的) class,
	 * such as {@code AnnotationConfigWebApplicationContext}.
	 * <p>Calling {@link #setContextInitializerClasses} (init-param 'contextInitializerClasses')
	 * indicates(指明) which {@code ApplicationContextInitializer} classes should be used to
	 * further(进一步) configure(安装配置) the internal application context prior to refresh().
	...
	/**
	 * Exposes the DispatcherServlet(调度程序)-specific(特定的) request attributes and delegates to {@link #doDispatch}
