 ...
 * 用于基于Web的主题解析策略的接口,允许通过请求进行主题解析和通过请求及响应修改主题。
 *
 ...
 *
 * <p>注意,此解析器仅负责确定当前主题名称。已解析主题名称的主题实例由DispatcherServlet通过各自的ThemeSource获得,即当前WebApplicationContext。
 *
